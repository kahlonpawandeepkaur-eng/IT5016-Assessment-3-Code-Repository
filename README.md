...
The Parking Meter System calculates the parking cost based on the parking time and generates a unique ticket ID. The program uses simple variables, an if-else statement and a function to complete the parking process.
...
The code was reviewed and improved by organising the sections and adding useful comments . In the future, the programs could be improved by  separating input, processing and output into different functions

## Conclusion 
Overall, the two programs demonstrate basic software design principles through simple structure, meaningful names, comments, functions and clear organisation. The analysis identifies areas where the code could be improved in the future. 
